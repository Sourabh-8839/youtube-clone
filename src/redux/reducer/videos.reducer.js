...
export const RelatVideoReducer = (
    state={
        loading:true,
        videos:[],
...
export const SearchVideosReducers = (state = {
...
export const SubscriptionChannelReducers = (state = {
...
export const VideoChannelReducers = (state = {
